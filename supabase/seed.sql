...
-- 1. Academic Year
-- Fixed ID: y->a for valid hex
INSERT INTO public.academic_years (id, name, start_date, end_date, active) VALUES
('a2025000-0000-0000-0000-000000000001', '2025-2026', '2025-09-01', '2026-06-26', true);
...
VALUES ('VedicRoots', 'a2025000-0000-0000-0000-000000000001', '09:15:00', '09:00:00', 1.00);

-- 3. Grades
-- Fixed ID: g->b for valid hex
...
-- KG 1
('Aarav', 'Sharma', 'c1000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001'), -- JK
('Ishani', 'Verma', 'c1000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002'), -- SK
-- KG 2
('Vihaan', 'Gupta', 'c2000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001'), -- JK
-- Lower Elementary
('Ananya', 'Iyer', 'c3000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000003'), -- Gr 1
('Reyansh', 'Malhotra', 'c3000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000005'), -- Gr 3
-- Upper Elementary
('Myra', 'Singh', 'c4000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000008'); -- Gr 6
