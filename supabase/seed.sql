...
('d0000000-0000-0000-0000-000000000001', 'Aarav', 'Sharma', '2019-05-15', 'aa000000-0000-0000-0000-000000000001'),
('d0000000-0000-0000-0000-000000000002', 'Ishani', 'Verma', '2020-03-20', 'aa000000-0000-0000-0000-000000000001'),
('d0000000-0000-0000-0000-000000000003', 'Vihaan', 'Gupta', '2019-08-10', 'aa000000-0000-0000-0000-000000000001'),
('d0000000-0000-0000-0000-000000000004', 'Myra', 'Singh', '2015-11-25', 'aa000000-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
...
('22000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'Aarav', 'Sharma', '2019-05-15', 'S1001'),
('22000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000002', 'Ishani', 'Verma', '2020-03-20', 'S1002'),
('22000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000003', 'Vihaan', 'Gupta', '2019-08-10', 'S1003'),
('22000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000004', 'Myra', 'Singh', '2015-11-25', 'S1004')
ON CONFLICT (id) DO NOTHING;
...
('22000000-0000-0000-0000-000000000004', '11000000-0000-0000-0000-000000000004', 'ff000000-0000-0000-0000-000000000004', 'cc000000-0000-0000-0000-000000000001', 'ACTIVE')  -- Myra -> Upper -> Grade 2
ON CONFLICT (id) DO NOTHING;
